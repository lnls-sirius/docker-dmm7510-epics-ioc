...
export DMM7510_CURRENT_LOG_IP=DMM7510_${DMM7510_INSTANCE}_LOG_IP
export DMM7510_CURRENT_LOG_PORT=DMM7510_${DMM7510_INSTANCE}_LOG_PORT
...
export DMM7510_LOG_IP=${!DMM7510_CURRENT_LOG_IP}
export DMM7510_LOG_PORT=${!DMM7510_CURRENT_LOG_PORT}
