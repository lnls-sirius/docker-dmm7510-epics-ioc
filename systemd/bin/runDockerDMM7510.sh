...
export DMM7510_CURRENT_PV_DEVICE_DMM_PREFIX=DMM7510_${DMM7510_INSTANCE}_PV_DEVICE_DMM_PREFIX
...
export EPICS_PV_DEVICE_DMM_PREFIX=${!DMM7510_CURRENT_PV_DEVICE_DMM_PREFIX}
...
/usr/bin/docker run \
    ...
    -RDMM ${EPICS_PV_DEVICE_DMM_PREFIX}
